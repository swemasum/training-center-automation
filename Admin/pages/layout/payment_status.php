...
$sql = "SELECT * FROM current_student where current_student_id='$s_id' ";
...
<div class="row">
  <div class="col-md-2">
    <p STYLE="FONT-WEIGHT:bold">ID: <?php echo $id; ?></p>
  </div>
  <div class="col-md-2">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2">
                      <div class="form-group">
                        ...
                        <input type="number" name="payed_amount" class="form-control" id="pwd">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-1 col-md-1">
                        <button style="margin-top:26px" type="pay"  class="btn btn-danger">submit</button>
                              ...
                              <div class="col-md-1 col-lg-1">
                                <a style="margin-top:26px"  href="all_student.php"  class="btn btn-danger">Check another</a>
          ...
          <thead>
            ...
            <?php
              include_once "../../../connection.php";
                  ...
                  $total_payable=0;
                  $sql = "SELECT * FROM payable where s_id='$s_id'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                      echo "<tr class='info'>";
                        ...
                        $total_payable=$total_payable+ $row["payable_amount"];
      ...
      <table class="table">
          <thead>
            ...
            <?php
                  ...
                  $total_payed=0;
                  $sql = "SELECT * FROM payed where s_id='$s_id'";
                  $result = mysqli_query($conn, $sql);
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td>" . $row["date"]."</td>";
                        ...
                        echo '<td><a href="delete_payed.php?id='.$row['payed_id']. '"">
        <span class="glyphicon glyphicon-remove"></span>
      </a>
...
<script type="text/javascript">
    var total_payable = "<?php Print($total_payable); ?>";
