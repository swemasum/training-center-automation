...
$sql = "INSERT INTO current_student (s_name,nick_name,college,class,phone_no,shift,father_mobile,mother_mobile,father_name,mother_name,requested_course,type,status,image)
VALUES ('$s_name','$nick_name','$college', '$class','$phone_no','$shift','$father_mobile','$mother_mobile','$father_name',
'$mother_name','$course','$type','active','$uniquename')";
