...
echo "new student".count($_SESSION['student_new']);
      for($i = 0 ; $i < count($_SESSION['student']) ; $i++) {
        ...
        //  echo '<td>'.$_SESSION['student'][$i].'</td><br>';
          ...
          $sql = "UPDATE result SET mcq='$marks' WHERE current_student_id='$roll' and exam_no='$exam_no'";
      ...
      for($i = 0 ; $i < count($_SESSION['student_new']) ; $i++) {
        ...
        //  echo '<td>'.$_SESSION['student'][$i].'</td><br>';
          ...
          $sql = "INSERT INTO result (current_student_id, batch_no,exam_no,mcq)
...
echo $already;
      ...
      for($i = 0 ; $i < count($_SESSION['student']) ; $i++) {
        ...
        //  echo '<td>'.$_SESSION['student'][$i].'</td><br>';
          ...
          $sql = "UPDATE result SET mcq='$marks' WHERE current_student_id='$roll'";
          $result = mysqli_query($conn, $sql);
      ...
      for($i = 0 ; $i < count($_SESSION['student_new']) ; $i++) {
        ...
        //  echo '<td>'.$_SESSION['student'][$i].'</td><br>';
          ...
          $sql = "INSERT INTO result (current_student_id, batch_no,mcq)
          VALUES ('$roll', '$batch_no','$marks')";
          $result = mysqli_query($conn, $sql);
