        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="add_student.php">
              <i class="fa fa-th"></i> <span href="add_student.php">Add student</span>
          ...
          <li>
            <a href="message.php">
              <i class="fa fa-th"></i> <span href="add_student.php">message</span>
              <span class="pull-right-container">
                <small class="label pull-right bg-green">new</small>
              </span>
            </a>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="payment_id.php"><i class="fa fa-circle-o"></i>Payment_id</a></li>
