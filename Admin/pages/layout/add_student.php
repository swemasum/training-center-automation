  ...
  <div class="content-wrapper">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                      ...
                      <input required type="text" class="form-control" name="s_name" id="name">
                    </div>
                  </div>
                  <div class="col-lg-2 col-md-2">
                    <div class="form-group">
                      <label for="nick_name">Nick Name:</label>
                      <input  type="text" class="form-control" name="nick_name" id="name">
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                      ...
                      <input required type="text" name="college" class="form-control" id="pwd">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="pwd">Mobile no:</label>
                      <input type="number" max="01999999999"  name="phone_no" maxlength="11"  placeholder="01xxx-xxxxxx" class="form-control" id="pwd">
                    </div>
                  </div>
    ...
    <hr>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="pwd">Guardian phone no:</label>
                  <input required type="number" max="01999999999"  name="father_mobile" maxlength="11"  placeholder="01xxx-xxxxxx" class="form-control" id="pwd">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="email" name="mother_mobile" class="form-control" placeholder="example@gmail.com" id="pwd">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <input  type="text" name="father_name"  class="form-control"  id="pwd">
                </div>
              </div>
              <div class="col-md-6 col-lg-6">
                <div class="form-group">
                  <label for="pwd">Mother name:</label>
                  <input  type="text" name="mother_name" class="form-control"  id="pwd">
                </div>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4">
          <div class="form-group">
            ...
            <input type="number" name="amount" class="form-control" id="pwd">
          </div>
        </div>
      </div>
