...
<div class="wrapper">
  ...
  echo "<td> " . $row["status"]."</td>";
                          echo '<td><a href="delete_message.php?id='.$row['message_id']. '"class="btn btn-info btn-lg">
          <span class="glyphicon glyphicon-remove"></span>
        </a>
        <a href="change_status_message.php?id='.$row['message_id']. '"class="btn btn-info btn-lg">
