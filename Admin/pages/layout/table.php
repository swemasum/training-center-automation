                ...
                include_once "../../../connection.php";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      while($row = mysqli_fetch_assoc($result)) {
                        echo "<tr class='info'>";
                          echo "<td>" . $row["s_name"]."(".$row["nick_name"].")<br>".$row["college"]."<br>Class:".$row["class"]."<br>Class:".$row["phone_no"]."</td>";
                          echo "<td>" . $row["father_name"]."<br>".$row["father_mobile"]."<br>".$row["f_profession"]."<br></td>";
                          echo "<td>" . $row["mother_name"]."<br>".$row["mother_mobile"]."<br>".$row["m_profession"]."<br></td>";
                          echo "<td>Course type: " . $row["type"]."<br>Course: ".$row["course"]."<br>Shif: ".$row["shift"]."</td>";
                          echo "<td>Method: " . $row["mayment_method"]."<br>ID: ".$row["pay_id"]."<br>Amount: ".$row["amount"]."</td>";
                          echo '<td> <img  height="100px" src="../../../application/'.$row["image"].'"</td>';
                          echo '<td><a href="accept.php?id='.$row['app_id']. '"class="btn btn-info btn-lg">
